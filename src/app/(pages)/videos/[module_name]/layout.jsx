...
export default function videoLayout({ children, params }) {
  ...
  const modules = JSON.parse(localStorage.getItem("videos")) || null;
  ...
  return (
    ...
    function X_Square({}) {
      return (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x-square" viewBox="0 0 16 16">
